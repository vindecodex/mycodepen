...
rating.addEventListener('mousemove',function(e){
  ...
  let val = ((e.pageX - ratingRect.left) / rating.offsetWidth) * 100  //subtract it with element postion left/x to avoid mouse gap
  ...
  sp.innerHTML = (val * .05).toFixed(1) // multiply it by .05 if we want perfect score will be 5 with decimal places of 1 as we set on toFixed functionp.innerHTML = val
})
